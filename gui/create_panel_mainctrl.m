...
handles.text_expminthrs100 = uicontrol(handles.panel_control,...
...
handles.edit_minthrsupdate = uicontrol(handles.panel_control,...
    ...
    'FontUnits','normalized','FontSize',lfs,'BackgroundColor','w',...
    'Tag','edit_minthrsupdate','Callback',@edit_sliderupdate_callback,...
...
handles.text_expmaxthrs100 = uicontrol(handles.panel_control,...
    'Style','text','Units','normalized','String','',...
    'FontUnits','normalized','FontSize',sfs,'BackgroundColor','w',...
    'HorizontalAlignment','left','Position',...
    [slider_maxthrs_pos(1)+slider_maxthrs_pos(3),...
...
handles.edit_maxthrsupdate = uicontrol(handles.panel_control,...
    ...
    'FontUnits','normalized','FontSize',lfs,'BackgroundColor','w',...
    'Tag','edit_maxthrsupdate','Callback',@edit_sliderupdate_callback,...
    'HorizontalAlignment', 'center','Position',...
...
handles.text_slicealphalabel = uicontrol(handles.panel_control,...
    'Style','text','Units','normalized','String','Slices opac:',...
    'FontUnits','normalized','FontSize',lfs,'BackgroundColor','w',...
    'HorizontalAlignment','left','Position',...
    [0.01,...
...
handles.text_expslicealpha100 = uicontrol(handles.panel_control,...
    'Style','text','Units','normalized','String','',...
    'FontUnits','normalized','FontSize',sfs,'BackgroundColor','w',...
    'HorizontalAlignment','left','Position',...
    [slider_alpha_pos(1)+slider_alpha_pos(3),...
...
handles.edit_slicealphaupdate = uicontrol(handles.panel_control,...
    ...
    'FontUnits','normalized','FontSize',lfs,'BackgroundColor','w',...
    'Tag','edit_slicealphaupdate','Callback',@edit_sliderupdate_callback,...
    'HorizontalAlignment','center','Position',...
...
handles.text_roialphalabel = uicontrol(handles.panel_control,...
   'Style','text','Units','normalized','String','Render opac:',...
    'FontUnits','normalized','FontSize',lfs,'BackgroundColor','w',...
    'HorizontalAlignment','left','Position',...
    [0.01,...
...
handles.text_exproialpha100 = uicontrol(handles.panel_control,...
    'Style','text','Units','normalized','String','',...
    'FontUnits','normalized','FontSize',sfs,'BackgroundColor','w',...
    'HorizontalAlignment','left','Position',...
    [slider_roialpha_pos(1)+slider_roialpha_pos(3),...
...
handles.edit_roialphaupdate = uicontrol(handles.panel_control,...
    ...
    'FontUnits','normalized','FontSize',lfs,'BackgroundColor','w',...
    'Tag','edit_roialphaupdate','Callback',@edit_sliderupdate_callback,...
    'HorizontalAlignment','center','Position',...
...
handles.text_expmincolor100 = uicontrol(handles.panel_control,...
    'Style','text','Units','normalized','String','',...
    'FontUnits','normalized','FontSize',sfs,'BackgroundColor','w',...
    'HorizontalAlignment','left','Position',...
    [slider_mincolor_pos(1)+slider_mincolor_pos(3),...
...
handles.edit_mincolorupdate = uicontrol(handles.panel_control,...
    ...
    'FontUnits','normalized','FontSize',lfs,'BackgroundColor','w',...
    'Tag','edit_mincolorupdate','Callback',@edit_sliderupdate_callback,...
    'HorizontalAlignment','center','Position',...
...
handles.text_expmaxcolor100 = uicontrol(handles.panel_control,...
    'Style','text','Units','normalized','String','',...
    'FontUnits','normalized','FontSize',sfs,'BackgroundColor','w',...
    'HorizontalAlignment','left','Position',...
    [slider_maxcolor_pos(1)+slider_maxcolor_pos(3),...
...
handles.edit_maxcolorupdate = uicontrol(handles.panel_control,...
    ...
    'FontUnits','normalized','FontSize',lfs,'BackgroundColor','w',...
    'Tag','edit_maxcolorupdate','Callback',@edit_sliderupdate_callback,...
    'HorizontalAlignment','center','Position',...
