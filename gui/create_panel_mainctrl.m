...
handles.checkbox_rendering = uicontrol(handles.panel_control, 'Style', 'checkbox',...
    ...
    'String','3D','BackgroundColor', 'w','Callback',@checkbox_rendering_callback);

%--------------------------------------------------------------------------
% creates the colormap dropdown menu
handles.popup_colormap = uicontrol(handles.panel_control, 'Style', 'popup',...
    'String', {'popup'},...
    'Units', 'normalized','Position', [0.165, 0.775, 0.2, 0.039],'background','w',...
    'Callback',@popup_colormap_callback);
...
handles.popup_roicolor = uicontrol(handles.panel_control, 'Style', 'popup',...
    'Units', 'normalized','Position', [0.37, 0.775, 0.2, 0.039],'background','w',...
...
handles.pbuttoncross.obj = uicontrol(handles.panel_control, 'Style', 'PushButton',...
    'Units', 'normalized','Position', [0.575, 0.775, 0.1, 0.04],...
    'String','+','ForeGroundColor',[1 0 0],'Callback',@pbuttoncross_callback);
handles.pbuttoncross.action = 1;

%--------------------------------------------------------------------------
% creates the delete pushbutton
handles.pbutton_delete = uicontrol(handles.panel_control, 'Style', 'PushButton',...
    'Units', 'normalized','Position', [0.68, 0.775, 0.1, 0.04],...
    'String','Del','Callback',@pbutton_delete_callback);

%--------------------------------------------------------------------------
% creates the move image up pushbutton
handles.pbutton_imgup = uicontrol(handles.panel_control, 'Style', 'PushButton',...
    'Units', 'normalized','Position', [0.785, 0.775, 0.1, 0.04],...
    'String','Up','Callback',@pbutton_imgup_callback);

%--------------------------------------------------------------------------
% creates the move image down pushbutton
handles.pbutton_imgdown = uicontrol(handles.panel_control, 'Style', 'PushButton',...
    'Units', 'normalized','Position', [0.89, 0.775, 0.1, 0.04],...
    'String','Down','Callback',@pbutton_imgdown_callback);
...
handles.text_slicealphalabel = uicontrol(handles.panel_control, 'Style', 'text',...
    'Units', 'normalized', 'String', 'Slices alpha:',...
    'BackgroundColor', 'w',... 'FontSize', 11,...
    'HorizontalAlignment', 'left','Position',...
    [0.01,...
...
handles.text_roialphalabel = uicontrol(handles.panel_control, 'Style', 'text',...
    'Units', 'normalized', 'String', 'ROI alpha:',...
    'BackgroundColor', 'w',... 'FontSize', 11,...
    'HorizontalAlignment', 'left','Position',...
    [0.01,...
