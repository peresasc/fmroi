function pbutton_imgdown_callback(hObject, ~)
% pbutton_imgdown_callback is an internal function of fMROI.
%
% Syntax:
%   pbutton_imgdown_callback(hObject, ~)
%
% Inputs:
...
lastimg = find(~cellfun(@isempty,st.vols), 1, 'last');
...
if n ~= lastimg
    ...
    %----------------------------------------------------------------------
    % change the color of the axes that are being permuted
