...
handles.buttongroup_spheremasktype = uibuttongroup(...
...
handles.radio_sphereradius = uicontrol(...
    ...
    'Units','normalized','String','radius','BackgroundColor','w',...
    'FontUnits','normalized','FontSize',fss*.7,'Position',[0,0,.45,1]);
...
handles.radio_spherevolume = uicontrol(...
    ...
    'FontUnits','normalized','FontSize',fss*.7,'Position',[.45,0,.55,1]);
