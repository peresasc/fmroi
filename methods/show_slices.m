...
strorient = {'L','R','P','A';'L','R','B','T';'A','P','B','T'};

if ~isfield(handles,'axannot')
    for i = 1:3
        handles.axannot(i,1) = annotation(handles.panel_graph(i),'textbox',...
            'Position',[0,.45,.1,.1],'String',strorient{i,1},...
            'Color','w','FitBoxToText','on','LineStyle','none',...
            'FontUnits','normalized','FontSize',.04,...
            'HorizontalAlignment','left','VerticalAlignment','middle');

        handles.axannot(i,2) = annotation(handles.panel_graph(i),'textbox',...
            'Position',[.9,.45,.1,.1],'String',strorient{i,2},...
            'Color','w','FitBoxToText','on','LineStyle','none',...
            'FontUnits','normalized','FontSize',.04,...
            'HorizontalAlignment','right','VerticalAlignment','middle');

        handles.axannot(i,3) = annotation(handles.panel_graph(i),'textbox',...
            'Position',[.45,0,.1,.1],'String',strorient{i,3},...
            'Color','w','FitBoxToText','on','LineStyle','none',...
            'FontUnits','normalized','FontSize',.04,...
            'HorizontalAlignment','center','VerticalAlignment','bottom');

        handles.axannot(i,4) = annotation(handles.panel_graph(i),'textbox',...
            'Position',[.45,.9,.1,.1],'String',strorient{i,4},...
            'Color','w','FitBoxToText','on','LineStyle','none',...
            'FontUnits','normalized','FontSize',.04,...
