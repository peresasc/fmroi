...
handles.text_scrshtnslices = uicontrol(handles.panel_scrshtctrl,...
    ...
    'String','Number of slices:','BackgroundColor','w',...
    'FontUnits','normalized','FontSize',fss*.7,...
    'Position',[.01,.84,.5,.15],'HorizontalAlignment','right');
