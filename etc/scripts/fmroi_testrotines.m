...
for w = 1:2 % strategy for running spheremask and cubicmask separately
    if w == 1
        datadir = {fullfile(datadir,'fmroi-spheremask');...
                   ...
                   fullfile(datadir,'fsl-spheremask');...
                   fullfile(datadir,'spm-spheremask');...
                   fullfile(datadir,'mricrongl-spheremask')};
    else
        datadir = {fullfile(datadir,'fmroi-cubicmask');...
                   fullfile(datadir,'afni-cubicmask');...
                   fullfile(datadir,'fsl-cubicmask');...
                   fullfile(datadir,'spm-cubicmask')};
    end
